...
for t=1:handles.daten.T
    ...
    string_ordnername = [handles.config.pfad.ausgangsdaten '\' string_datum '-KEP' '\NNF-' num2str(t)];
...
cellwrite_german([handles.config.pfad.ausgangsdaten '\' string_datum '-KEP' '\Zeitreihen_Handel.csv'],ausgabe_zeitreihenhandel);
